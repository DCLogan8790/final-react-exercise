...
function App() {
  ...
  // 8a
  // The function passed into the useEffect function/hook will run every time the state value that is passed into the array (2nd argument) is updated. (NOTE: If nothing is passed in for a second argument, then teh function will run whenever any state values are updated)
  useEffect( () => {
